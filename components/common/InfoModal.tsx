        ...
        <div className="p-6 space-y-5 text-neutral-700 text-sm leading-relaxed">
          ...
          {stageData && (
            <div className="space-y-4">
              <p className="font-semibold text-[#092233]">{stageData.headline}</p>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {stageData.activities.map((act, idx) => (
                    <li key={idx} className="flex items-start gap-2 text-xs sm:text-sm text-[#092233]">
                      <span className="w-4 h-4 rounded-full bg-[#8cc63f]/20 text-[#609b19] flex items-center justify-center shrink-0 mt-0.5">
